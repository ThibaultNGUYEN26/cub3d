...
/*   Updated: 2024/01/16 20:44:08 by thibault         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_mlx_init(t_data *data)
{
	...
	data->prev_mouse_x = -1;
    data->texture->t_north = "./textures/1.xpm";
    data->texture->t_south = "./textures/2.xpm";
    data->texture->t_west = "./textures/3.xpm";
    data->texture->t_east = "./textures/4.xpm";
